...
sudo unrar x "$INSTALL_DIR/TimpiCollectorLinuxLatest.rar" -d "$INSTALL_DIR" || handle_error
...
sudo mv "$INSTALL_DIR/TimpiCollector-0-9-3-Linux-update/0.9.3.txt" "$INSTALL_DIR/" || handle_error
