...
* **[Windows](https://github.com/Timpi-official/Nodes/blob/main/Collector/guides/Windows.md)** — native v2 build, installs as a Windows service. No auto-updater: re-run the installer to update.
