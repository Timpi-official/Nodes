...
[§8 of the guide](https://github.com/Timpi-official/Nodes/blob/main/DockerCollector/Tutorial/LinuxDockerCollectorLatest.md#autoupdate).
...
* **[Native Linux (systemd)](https://github.com/Timpi-official/Nodes/blob/main/Collector/scripts/CollectorLinux.md)** — ⚠️ retired, no longer updated. Migrate to Docker.
* **[Windows](https://github.com/Timpi-official/Nodes/blob/main/Collector/scripts/CollectorWindows.md)** — separate installer.
