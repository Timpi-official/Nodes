...
:small_blue_diamond: [Synaptron for Windows](https://timpi.io/applications/windows/synaptron_win_latest.zip) Extract using [WinRAR](https://www.win-rar.com/start.html?&L=0)
